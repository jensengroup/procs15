                    ...
                    target.create_options(
                         ...
                         make_vector(
                              ...
                              make_vector(std::string("sample-weights"),
                                          std::string("Sample weights in the energy term or use fixed values (=true)"),
                                          &settings->sample_weights),
                              make_vector(std::string("intercept-model"),
                                          std::string("Model for handling the offset between predicted chemical shieldings and experimental chemical shifts (=MLE)"),
                                          &settings->intercept_model),
                              make_vector(std::string("slope-model"),
                                          std::string("Model for handling the scaling between predicted chemical shieldings and experimental chemical shifts (=MLE)"),
                                          &settings->slope_model),
